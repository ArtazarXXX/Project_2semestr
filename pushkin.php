        ...
        <div class="main">
            <div class="title">
                <ul class="bread-crumb">
                    ...
                    <li class="bread-crumb__unit bread-crumb__unit_delete">/</li>
                    <li class="bread-crumb__unit"><a href="/pushkin.php" class="bread-crumb__link">А. С. Пушкин</a></li>
                </ul>
                <div class="title__name">КНИГИ</div>
            </div>
            <div class="philosophy">
                <img src="/img/pushkin/mpphoto.jpg" alt="Пушкин" class="philosophy__image">
            </div>
        </div>
    </header>
    <main>
        ...
        <div class="assortments">
            <?php
                ...
                while ($i < count($titles)) {
                    echo
                    '<a href="pushkin-book.php/?id='. $ids[$i] .'" class="assortments-unit wow fadeInUp">
