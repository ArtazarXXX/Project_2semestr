        ...
        <div class="main">
            <div class="title">
                <ul class="bread-crumb">
                    ...
                    <li class="bread-crumb__unit"><a href="/rusclas.html" class="bread-crumb__link">Русская классика</a></li>
                    <li class="bread-crumb__unit bread-crumb__unit_delete">/</li>
                    <li class="bread-crumb__unit"><a href="/bulgakov.php" class="bread-crumb__link">М. А. Булгаков</a></li>
                </ul>
                <div class="title__name">КНИГИ</div>
            </div>
            <div class="philosophy">
                <img src="/img/bulgakov/mpphoto.jpg" alt="Булгаков" class="philosophy__image">
            </div>
        </div>
    </header>
    <main>
        ...
        <div class="assortments">
            <?php
                ...
                while ($i < count($titles)) {
                    echo
                    '<a href="bulgakov-book.php/?id='. $ids[$i] .'" class="assortments-unit wow fadeInUp">
                        <img src="' . $imgs[$i] . '" alt="Книга Булгакова" class="assortments-unit__image">
