        ...
        <div class="main">
            <div class="title">
                <ul class="bread-crumb">
                    ...
                    <li class="bread-crumb__unit bread-crumb__unit_delete">/</li>
                    <li class="bread-crumb__unit"><a href="/duma.php" class="bread-crumb__link">Александр Дюма</a></li>
                </ul>
                <div class="title__name">КНИГИ</div>
            </div>
            <div class="philosophy">
                <img src="/img/duma/mpphoto.jpg" alt="Булгаков" class="philosophy__image">
            </div>
        </div>
    </header>
    <main>
        ...
        <div class="assortments">
            <?php
                ...
                while ($i < count($titles)) {
                    echo
                    '<a href="/duma-book.php/?id='. $ids[$i] .'" class="assortments-unit wow fadeInUp">
